...
export const ScrambleWords = () => {
  ...
  const handleGuessSubmit = (e: React.FormEvent) => {
    ...
    // if (errorCounter >= maxAllowErrors - 1 || points == 17) {
    //   setIsGameOver(true);
    // }
  ...
  const updateRadomWord = () => {
    const updatedWords = words.slice(1);
    // const shuffledArray = shuffleArray(updatedWords);
    setWords(updatedWords);

    // const newWord = chooseRadomWord(shuffledArray);
