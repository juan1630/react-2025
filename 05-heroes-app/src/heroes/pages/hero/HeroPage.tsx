...
import { getHeroByNameAction } from "@/heroes/actions/get-hero-by-name";
...
export const HeroPage = () => {
  ...
  const { data: hero, isError } = useQuery({
    ...
    queryFn: () => getHeroByNameAction(idSlug),
    retry: false,
  });
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="flex-1 text-center md:text-left">
                <div className="flex flex-wrap gap-2 justify-center md:justify-start mb-4">
                  <Badge className="text-white">{hero?.category}</Badge>
                  <Badge className="text-white">{hero?.status}</Badge>
                  <Badge
                    variant="secondary"
